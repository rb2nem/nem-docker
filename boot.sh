...
docker run --restart always --name mynem_container -v ${PWD}/nem:/home/nem/nem $config_mounts -t -d  -p 7777:7777 -p 7778 -p 7880:7880 -p 7890:7890 -p 8989:8989 mynem_image
set +x
