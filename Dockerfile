...
RUN curl http://bob.nem.ninja/nis-ncc-0.6.42.tgz > nis-ncc-0.6.42.tgz
RUN curl http://bob.nem.ninja/nis-ncc-0.6.42.tgz.sig > nis-ncc-0.6.42.tgz.sig
RUN gpg --keyserver keys.gnupg.net --recv-key A46494A9
RUN gpg --verify nis-ncc-0.6.42.tgz.sig nis-ncc-0.6.42.tgz && tar zxf nis-ncc-0.6.42.tgz
